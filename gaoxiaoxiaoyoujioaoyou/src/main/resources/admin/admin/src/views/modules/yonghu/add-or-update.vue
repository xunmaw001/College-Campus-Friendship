        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="兴趣爱好" prop="aihaoTypes">
                        <el-select v-model="ruleForm.aihaoTypes" :disabled="ro.aihaoTypes" placeholder="请选择兴趣爱好">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="兴趣爱好" prop="aihaoValue">
                        <el-input v-model="ruleForm.aihaoValue"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="个人简介" prop="yonghuContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yonghuContent" label="个人简介" prop="yonghuContent">
