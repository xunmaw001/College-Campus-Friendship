    ...
    <view class="content">
        ...
        <view class="list">
            ...
            <view v-for="item in menuList" v-bind:key="item.roleName">
                <view v-if="role==item.roleName" v-bind:key="index" v-for=" (menu,index) in item.backMenu">
                    <view v-bind:key="sort" v-for=" (child,sort) in menu.child">
                        <view
                                :style='{"backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#8E2DE2","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 1rpx  0"}'
                                @tap="onPageTap('../'+child.tableName+'/list?userid='+user.id)" class="li"
                                hover-class="hover">
                            <view :style='{"color":"#A27DE3","fontSize":"28rpx"}' class="text">
                                {{child.menu}}</view>
                            <view class="cuIcon-right" :style='{"color":"#A27DE3","fontSize":"28rpx"}'>
                            </view>
                        </view>
                    </view>
                </view>
			...
			<view @tap="onPageTap('../forum/forum-my')"
                ...
                <view class="text" :style='{"color":"#A27DE3","fontSize":"28rpx"}'>我的发贴</view>
                <!-- <image class="to" :style='{"color":"#A27DE3","fontSize":"28rpx"}' src="/static/center/to.png"></image> -->
                <view class="cuIcon-right" :style='{"color":"#A27DE3","fontSize":"28rpx"}'></view>
            </view>
